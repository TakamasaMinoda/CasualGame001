...
namespace Slicer2D
{
	public class Rice02SliceEvent : MonoBehaviour
	{
		...
		void Start()
		{
			...
			if (currentSize == 0)
			{
				...
				currentSizePercent = (float)System.Math.Round((currentSize / GameObject.Find("DataHolder").GetComponent<Data>().GetOriginalRiceSize(2)) * 100);
			}
		...
		private void OnCollisionEnter2D(Collision2D collision)
		{
			...
			{
				//アイコンの生成
				if (0 <= currentSizePercent && currentSizePercent < 70) //0～２９
				{
