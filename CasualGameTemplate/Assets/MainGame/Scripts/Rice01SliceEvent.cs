...
namespace Slicer2D
{
	public class Rice01SliceEvent : MonoBehaviour
	{
		...
		void Start()
		{
			...
			if (currentSize == 0)
			{
				...
				currentSizePercent = (float)System.Math.Round((currentSize / GameObject.Find("DataHolder").GetComponent<Data>().GetOriginalRiceSize(1)) * 100);
			}
