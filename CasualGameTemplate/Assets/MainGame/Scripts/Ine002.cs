...
public class Ine002 : MonoBehaviour
{
	...
	void Start()
	{
		...
		//スポーン機能再開
		GameObject.Find("EnemySpawn_2").GetComponent<EnemySpawner>().StartSpawn();
	}
	...
	private void Update()
	{
		...
		//マシーンを止める
		if(GameObject.Find("EnemySpawn_2"))
		{
			GameObject.Find("EnemySpawn_2").GetComponent<EnemySpawner>().StopSpawn();
		}
