...
namespace Slicer2D
{
	public class CowTail : MonoBehaviour
	{
		...
		void Start()
		{
			...
			if (currentSize == 0)
			{
				...
				//ここかえる
				currentSizePercent = (float)System.Math.Round((currentSize / GameObject.Find("DataHolder").GetComponent<Data>().GetOriginalCowTailSize()) * 100);
			}
